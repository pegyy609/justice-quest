...
const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "case.evidence": "Investigate the Scene",
    "case.evidenceHint": "Tap suspicious areas of the scene to discover evidence. Wrong taps cost 1 attempt.",
    "case.evidenceHint.lens": "★ Truth Lens active — reliability of each evidence is revealed.",
    "case.markedReliable": "found",
    "case.attempts": "Attempts left",
    "case.found": "Evidence found",
    "case.proceed": "Proceed to Judgement ▶",
    "case.outOfAttempts": "Out of attempts. Proceed to judgement with what you have.",
    "case.noneFound": "No evidence discovered yet — try tapping the scene.",
    ...
    "case.sourceCaveats": "Source & Caveats",
  ...
  zh: {
    ...
    "case.statements": "陈述",
    "case.evidence": "调查现场",
    "case.evidenceHint": "点击现场中可疑的区域以发现证据。点错会扣 1 次机会。",
    "case.evidenceHint.lens": "★ 真相之镜已生效 — 显示每项证据的可靠性。",
    "case.markedReliable": "已发现",
    "case.attempts": "剩余机会",
    "case.found": "已发现证据",
    "case.proceed": "进入判决 ▶",
    "case.outOfAttempts": "机会用尽。请用现有证据进入判决。",
    "case.noneFound": "尚未发现证据 — 试着点击现场。",
    "case.reasoning": "法律推理",
  ...
  ms: {
    ...
    "case.evidence": "Siasat Tempat Kejadian",
    "case.evidenceHint": "Ketik kawasan mencurigakan di tempat kejadian untuk cari bukti. Ketikan salah kurangkan 1 cubaan.",
    "case.evidenceHint.lens": "★ Kanta Kebenaran aktif — kebolehpercayaan setiap bukti didedahkan.",
    "case.markedReliable": "ditemui",
    "case.attempts": "Cubaan tinggal",
    "case.found": "Bukti ditemui",
    "case.proceed": "Teruskan ke Penghakiman ▶",
    "case.outOfAttempts": "Cubaan habis. Teruskan ke penghakiman dengan bukti sedia ada.",
    "case.noneFound": "Belum ada bukti ditemui — cuba ketik tempat kejadian.",
    ...
    "case.sourceCaveats": "Sumber & Peringatan",
